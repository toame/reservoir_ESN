...
void generate_input_signal_random(std::vector<std::vector<double>>& input_signal, const int u_min, const int u_delta, const int num, const int step, const int seed);
...
void generate_narma_task(std::vector<std::vector<double>>& input_signal, std::vector<std::vector<double>>& teacher_signal, int tau, int step);
