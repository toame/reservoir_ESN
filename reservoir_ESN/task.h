...
void generate_narma_task(std::vector<double>& input_signal, std::vector<double>& teacher_signal, const int tau, int step, std::vector<int>& order, bool test_mode = false);
...
double calc_correct_rate(const std::vector<double>& teacher_signal, const std::vector<double>& weight, const std::vector<double>& weight2,
	const std::vector<std::vector<double>>& output_node, const std::vector<std::vector<double>>& output_node2, const int unit_size, const int wash_out, 
	const int step, std::vector<int>& order, bool show = false, std::string name = "");
